...
# date_to_forecast <- "YYYY-MM-DD"    # <--- You will need to code this in and uncomment it
# forecast_variables <- ####   # <---  This will be all the forecast variables from your regression equation. You will need to code this in and uncomment it.
...
# You will need to uncomment this code
date_to_forecast <- "2024-01-01"    # <--- You will need to code this in and uncomment it
forecast_variables <- c("air_temperature", "surface_downwelling_longwave_flux_in_air")    # <---  This will be all the forecast variables from your regression equation. You will need to code this in and uncomment it.
