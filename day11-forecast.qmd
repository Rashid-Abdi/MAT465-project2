...
# regression_formula <-   # <--- You will need to code this in and uncomment it

# forecast_fit <- fit_lm_model(target_data = ### ,   # <--- fill in the correct data table
#                             noaa_data = ### ,  # <--- fill in the correct data table
